...
export default class MensBraids extends Component {
  render() {
    return (
      <div>
                            ...
                            <div className="col-12">
                                <nav aria-label="breadcrumb">
                                    <ol className="breadcrumb">
                                        ...
                                        <li className="breadcrumb-item active" aria-current="page">Mens's Braids</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
		...
		<div className="container-fluid" id="add-padding">
                <div className="col-md-6 col-lg-12">
						<div className= "section-title section-title--3 align-items-center-align mb-0" >
							<h2>Men's Braid Styles Gallery</h2>
                        </div>
                 </div>
